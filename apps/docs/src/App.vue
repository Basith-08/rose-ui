...
import { Badge, Button, Modal } from '@kagami.b/rose-ui'
        ...
        >
            <div class="space-y-4">
                <p class="text-sm leading-6 text-slate-600">
                    Install `@kagami.b/rose-ui`, `@kagami.b/tokens`, and `vue`, then extend your Tailwind setup with the Rose token values so component utility classes resolve correctly.
                </p>
